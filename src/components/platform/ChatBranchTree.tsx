        ...
        {branchRenders.map((branch, bi) => {
          ...
          return (
            <g key={bi}>
              ...
              <path
                d={`M ${MAIN_X} ${startY} C ${MAIN_X} ${startY + 20}, ${BRANCH_X} ${firstBranchY - 20}, ${BRANCH_X} ${firstBranchY}`}
                fill="none"
          ...
          return (
            <div key={`${bi}-${item.id}`} className="absolute" style={{ top: rowIdx * ROW_HEIGHT, left: 0, height: ROW_HEIGHT }}>
              ...
              <button
                ...
                className="flex items-center gap-2 h-full hover:bg-secondary rounded-md px-1 transition-colors"
              >
                <div
                  className="shrink-0 rounded-full flex items-center justify-center"
                  style={{
                    ...
                    marginLeft: BRANCH_X - BRANCH_NODE_SIZE / 2,
                  }}
                >
